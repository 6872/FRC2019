...
public class OI {
    ...
    public JoystickButton disablePIDAltButton;
    ...
    public OI() {
        ...
        disablePIDButton = new JoystickButton(gamepad, 10);
        ...
        disablePIDAltButton = new JoystickButton(joystick, 2);
        disablePIDAltButton.whenPressed(new DisableTowerPID());
