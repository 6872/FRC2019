...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Control Intake: suck", new ControlIntake(true));
        SmartDashboard.putData("Control Intake: propel", new ControlIntake(false));
        ...
        SmartDashboard.putData("Move Tower: up", new MoveTower(1));
        SmartDashboard.putData("Move Tower: down", new MoveTower(-1));

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS

        pov = new POVhat(joystick);

        pov.Down.whenActive(new ControlIntake(true));
        pov.Up.whenActive(new ControlIntake(false));
        pov.Left.whenActive(new MoveTower(0.5));
        pov.Right.whenActive(new MoveTower(-0.5));
    }
