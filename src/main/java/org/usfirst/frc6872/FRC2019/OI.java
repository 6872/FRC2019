...
public class OI {
    ...
    public JoystickButton towerChassisButton2;
    public JoystickButton ballLevel2Button2;
    ...
    public OI() {
        ...
        ballLevel2Button2 = new JoystickButton(gamepad2, 8);
        ballLevel2Button2.whenPressed(new SetLevel(Tower.Ball2));
        towerChassisButton2 = new JoystickButton(gamepad2, 8);
        towerChassisButton2.whenPressed(new SetLevel(Tower.Robot));
